...
_axiosDefault.default.get("https://my-json-server.typicode.com/modanisatech/bootcamp-db/products").then((response)=>{
    ...
    data.forEach((element, index)=>{
        if (element.name.includes('Şal')) console.log(element.name);
    });
...
},{"./styles.css":"igzwc","axios":"1IeuP","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"igzwc":[function() {},{}],"1IeuP":[function(require,module,exports) {
...
},{}]},["1Mq12","5HwUs"], "5HwUs", "parcelRequirec451")
